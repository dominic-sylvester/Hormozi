...
[Image of a $100 bill with Benjamin Franklin's portrait]
...
_How to make offers so good people feel stupid saying no_
...
> *“We first found out about Alex and instantly bought his book. It’s the best book I’ve ever read really in business. Probably the biggest thing I learned from him is that so many times in business you want to charge your customers more and you almost feel guilty like ‘oh my gosh can I really do this?’ but I think there's nobody better that really puts packages and prices together that not only you can increase your price for your business but you're also increasing the value for the customer at the exact same time.* **Since we started working with him...within two months...our business was already doing $10M/yr in sales...INSTANT**


---


> **DOUBLE and it’s only been two months since we came in touch with him and our business is on a run rate to do $23M/yr in sales now.** *Just from changing our pricing, our packaging, and at the same time delivering better results and outcomes for the clients that we work with.”*  
>  
...
* _a term used to describe a person (usually a woman) that is willing to do anything for their partner, friend, or family, even in the face of danger._  
...
Thank you for spending hours upon hours beating up the ideas that became this  
book  
with me.  
...
After beginning a series of books on acquisition, it became apparent that I could not talk about any other topic without first addressing *the offer*: the starting point of any conversation to initiate a transaction with a customer. What


---


you are literally *providing* them in exchange for their money. That’s where it all begins.
...
# Section III: Value Offer

**Problems → Solutions → Bundle**

- Problems: multiple red crosses (×) inside a cloud with a sad face
- Solutions: multiple checkboxes, some checked
- Bundle: a cube with labeled sides (e.g., "home," "car," "auto")

# Section IV: Enhancing

| Before       | After                      |
|--------------|----------------------------|
| Cube 1 (labeled "111") | Cube on tripod with labels: 1 left, bonus 1, bonus 2, bonus 3 |
| Cube 2 (labeled "222") |                            |
| Cube 3 (labeled "333") |                            |
| Cube 4 (labeled "444") |                            |
...
- Conveyor belt with cubes labeled "111," "222," "333" moving on the left side
- Conveyor belt with money bags ($) on the right side
...
stung. I felt defeated. “Listen, this could go horribly wrong,”  
...
<tr>
  <th>Month</th>
  <th>Pending Authorizations<br>Count</th>
  <th>Pending Authorizations<br>Amount</th>
  <th>Charges<br>Count</th>
  <th>Charges<br>Amount</th>
  <th>Refunds<br>Count</th>
  <th>Refunds<br>Amount</th>
  <th>Rtns/Chgbks<br>Count</th>
  <th>Rtns/Chgbks<br>Amount</th>
  <th>Voids<br>Count</th>
  <th>Voids<br>Amount</th>
  <th>Declines<br>Count</th>
  <th>Declines<br>Apprvl Pct</th>
  <th>Totals<br>Count</th>
  <th>Totals<br>Amount</th>
</tr>
</thead>
<tbody>
<tr>
...
<tr>
  ...
  <td>$0.00</td>
  <td><b>8991</b></td>
  <td><b>$7,409,908.60</b></td>
  <td><b>226</b></td>
  <td><b>-$101,722.60</b></td>
  <td><b>465</b></td>
  <td><b>-$487,354.99</b></td>
  <td><b>59</b></td>
  <td><b>$24,759.48</b></td>
  <td><b>1491</b></td>
  <td><b>86%</b></td>
  <td><b>11232</b></td>
  <td><b>$6,820,831.01</b></td>
</tr>
</tbody>
</table>
...
[The image shows two photos side by side. The left photo shows three people standing together, one of whom is Arnold Schwarzenegger. The right photo shows two men, one of whom is Arnold Schwarzenegger, both wearing cowboy hats.]

Leila and I meeting with Arnold Schwarzenegger at his home. We are now on the national board of his charity *After School All Stars*. Creating Grand Slam Offers has given us access to people we only dreamed of.
...
I know I teleported you from rags to riches. And the natural question is *how?*  
That’s what I’m going to use the rest of this book (and remaining books & free courses in this Acquisition.com series) to break down.
...
A purple four-piece pyramid logo followed by the text:  
**ACQUISITION.COM**  
...
If you look carefully, the process reverse-engineers success. I think it’s pretty cool. Here’s how: I know these business owners can execute the frameworks I have without hand-holding, and therefore, would be very likely to succeed with the next set of frameworks (getting to $30M, $50M, $100M looks  


---


different than getting to $3-$10M). They know that my style works for them, because it already has. So we operate on shared trust - I trust they can execute, and they trust that our stuff works - again, because it already has….all while helping everyone else….fo’ free. So it allows me to preemptively avoid failures and dramatically increases success likelihood. Let me show you how much….
...
*Illustration of a person standing under a curved path with a large green checkmark*

----

# Section II: Pricing

| Group of people | Apple | $ |
|-----------------|-------|---|
| Single person   | Orange | $ |
...
| Problems | Solutions | Bundle |
|----------|-----------|--------|
| [red X marks] | [green check marks] | [box labeled with various items] |
...
| Before | After |
|--------|-------|
| Cube 1 (labeled "111") | Cube 1 (labeled "111") with enhancements |
| Cube 2 (labeled "111") | Cube 2 (labeled "111") with enhancements |
| Cube 3 (labeled "111") | Cube 3 (labeled "111") with enhancements |
| Cube 4 (labeled "111") | Cube 4 (labeled "111") with enhancements |

*Enhancements include three icons labeled "Bonus 1", "Bonus 2", and "Bonus 3"*
...
*Conveyor belt with three cubes labeled "111" on the left side and three money bags with dollar signs on the right side*
...
$$
\text{Revenue: } (\$1,000/\text{mo} \times 90\% \text{ Gross Margin} \times 5 \text{ months}) = \$4,500 \text{ Lifetime Value (LTV)}
$$
...
This book was intended to be a textbook for any business that wants to *grow*. I’ve spent (and continue to spend) hundreds of hours on calls and in-person meetings consulting entrepreneurs on crafting their offers. I have seen the ones
...
<td>$10,000</td>
<td></td>
<td>Dollars Spent on advertising</td>
</tr>
<tr>
<td>Impressions Reached</td>
<td>300,000</td>
<td></td>
<td>Eyeballs reached from advertising</td>
</tr>
<tr>
<td>Response Rate</td>
<td>0.00013</td>
<td></td>
<td>Percentage of people who book call (CTR x Optin %)</td>
</tr>
<tr>
<td>Appts Booked</td>
<td>40</td>
<td></td>
<td># of Appointments Booked as a result</td>
</tr>
<tr>
<td>Show Rate</td>
<td>75%</td>
<td></td>
<td>Percentage of people who book call</td>
</tr>
<tr>
<td>Appts Showed</td>
<td>30</td>
<td></td>
<td># of people who show up for their appt</td>
</tr>
<tr>
<td>Closing %</td>
<td>16%</td>
<td></td>
<td>% of people who purchase</td>
</tr>
<tr>
<td>Appts Closed</td>
<td>5</td>
...
<td>$1,000</td>
<td></td>
<td>The amount that people put down to begin service</td>
</tr>
<tr>
<td>Total</td>
<td>$5,000</td>
<td></td>
<td>Total amount of up front cash collected</td>
</tr>
<tr>
<td>ROAS</td>
<td>.5 : 1</td>
...
*This commoditization creates a price-driven purchase . . .*
...
<td>0.00013</td>
<td>0.00033</td>
<td><b>2.5x Response (more appealing, so more respond)</b></td>
</tr>
<tr>
<td>Appts Booked</td>
<td>40</td>
...
<td>16%</td>
<td>37%</td>
<td><b>2.3x Closing (more value, so more buy)</b></td>
</tr>
<tr>
<td>Appts Closed</td>
<td>5</td>
...
<td>$1,000</td>
<td>$3,997</td>
<td><b>4x Price (one time fee vs recurring)</b></td>
</tr>
<tr>
<td>Total</td>
<td>$5,000</td>
<td>$112,000</td>
<td><b>22.4x Cash Up Front Collected</b></td>
</tr>
<tr>
<td>ROAS</td>
<td>0.5 : 1</td>
<td>11.2 : 1</td>
<td><b>Get paid to get customers.</b></td>
</tr>
</tbody>
</table>

**Breakdown:** You spend the same amount of money for the same eyeballs. Then, you get 2.5x more people to respond to your advertisement because it’s a more compelling offer. From there, you close 2.5x as many people because the offer is so much more compelling. From there, you are able to charge a 4x higher price up front. The end result is $$2.5 \times 2.5 \times 4 = 22.4x$$ more cash collected.


---


up front. Yes, you spent $10,000 to make $112,000. You just *made money* getting new customers.
...
[The image shows a group of stick figures holding up money bills toward a single stick figure standing on a red platform labeled "OFFER".]
...
Let’s break it down. It wasn’t his product — that was great. It wasn’t his offer — he had a zero risk revshare model. It wasn’t his sales skills — he was a natural salesman. So, then what was the problem? *He was selling to newspapers!* His market was shrinking by 25 percent *every year*! He had looked at all the
...
| 1) PAIN (sad face) | + | 2) PURCHASING POWER (money) | + | 3) EASY TO TARGET (magnifying glass) | + | 4) GROWING (upward graph) |
...
<table>
  <tr>
    <td colspan="3" align="center"><b>Health</b></td>
  </tr>
<tr>
    <td><b>Wealth</b></td>
    <td></td>
...
<tr>
    <td colspan="3" align="center">[Small figure of a weak person → strong person under Health]</td>
  </tr>
</table>
...
**Reason:** you can literally charge 100x more for the *exact* same product. Dan
...
<tr>
<td>Time Management For Sales Professionals</td>
<td>$99</td>
</tr>
<tr>
<td>Time Management For Outbound B2B Sales</td>
<td>$499</td>
</tr>
<tr>
<td>Time Management For Outbound B2B Power Tools &amp; Gardening Sales Reps</td>
<td>$1997</td>
</tr>
</tbody>
</table>
...
**_Now we shall unleash the power of niche pricing in various stages on your product_**  
...
If you try *one hundred offers, I promise* you will succeed. Most people never try anything. Others fail once, then give up. It takes resilience to succeed. Stop personalizing! It’s not about you! If your offer doesn’t work, it doesn’t mean you
...
So, try again. You’ll never become world class if you stop after a failed attempt.  
...
comprehend and believe there must have been a mistake. And it inspires a select few, who are bound for greatness.  
...
[The image shows a diagram titled "PRICE TO VALUE DISCREPANCY." It features two thick arrows intersecting: a horizontal arrow labeled "PRICE" pointing right, and a downward slanting arrow labeled "VALUE" pointing down and right. The VALUE arrow starts higher than the PRICE arrow, with green dollar signs ($) above it, and then crosses below the PRICE arrow at a point labeled "POINT OF CANCELLATION." After this point, red dollar signs ($) appear below the PRICE arrow.]
...
In plain words, pricing this way means you are providing a service at just above what it costs for you to stay above water. We are *not* trying to stay barely above water. We are trying to make egregious amounts of money that will have
...
<table>
  <thead>
    <tr>
      <th colspan="2">Virtuous vs. Vicious Cycle of Price $</th>
      <th></th>
    </tr>
  </thead>
  <tbody>
...
<tr>
      <td><b>Your Clients</b></td>
      <td><b>Your Business</b></td>
      <td></td>
    </tr>
<tr>
      <td>Emotional Investment</td>
      <td>Profit</td>
      <td>Increase</td>
    </tr>
<tr>
      <td>Perceived Value</td>
      <td>Perceived Value of Self</td>
      <td>Increase</td>
    </tr>
<tr>
      <td>Results</td>
      <td>Perception of Impact (Results)</td>
      <td>Increase</td>
    </tr>
<tr>
      <td>Demandingness</td>
...
<tr>
      <td>Revenue for Fulfillment per Customer</td>
      <td>Sales Team Conviction</td>
      <td>Increase</td>
    </tr>
  </tbody>
</table>
...
* _Retail Sales_: +$4,400/mo in retail product sales revenue  
* _Prices_: From $129/mo to $167/mo  
...
# Section I: How We Got Here
*Illustration of a person standing under a large curved path*  
✔️
...
# Section III: Value Offer
**Problems → Solutions → Bundle**  
- Problems: multiple red X marks in a thought bubble, sad face below  
- Solutions: check marks on boxes  
- Bundle: a cube with labels "tools 1", "tools 2", "tools 3" and a price tag  
**You ARE HERE!**

# Section IV: Enhancing
| Before (multiple cubes with "tools" tags) | After (one cube on a stand with "tools 1", "tools 2", "tools 3") |
|--------------------------------------------|------------------------------------------------------------------|
| 5 cubes with "tools" tags                   | 1 cube with "1 left" note and "$" signs on the right side         |
|                                            | Numbers: 29 ... 28 ...                                             |

# Section V: Execution
- Conveyor belt with cubes labeled "tools" on the left side  
- Conveyor belt with bags of money ($) on the right side
...
Many entrepreneurs believe that charging “too much” is bad. The reality is that, yes, you should never charge more than your product is *worth.* But you


---


should charge *far* more for your product and services than it costs to fulfill it. Think up to a hundred times more, not just two or three times more. And if you provide enough *value*, it should still always be a *steal* for the prospect. That is the power of value. It unleashes unlimited pricing and profit power to scale your company.
...
\text{Value} = \frac{
\begin{array}{c}
\text{Dream Outcome} \times \text{Perceived Likelihood of Achievement}
\end{array}
}{
\begin{array}{c}
\text{Time Delay} \times \text{Effort \& Sacrifice}
\end{array}
}
$$
...
> **Pro Tip: Frame benefits in terms of status gained _from the viewpoint of others_**  
> When writing copy, you can make it that much more powerful by talking about how _other people_ will perceive the prospect’s achievement. Connect the dots for them. Example:  
> If you buy this golf club, your drive will increase by 40 yards. Your golf buddies' jaws will drop when they see your ball soar 40 yards past theirs . . . they’ll ask you what’s changed . . . only you will know.
...
It’s good to understand both. The thing people *buy* is the long-term value,
...
<thead>
<tr>
<th>Fitness Effort and Sacrifice:</th>
<th>liposuction effort and sacrifice:</th>
</tr>
</thead>
<tbody>
<tr>
<td>Wake up one to two hours earlier in the morning</td>
<td>Fall asleep</td>
</tr>
<tr>
<td>Five to ten hours per week of time lost</td>
<td>Wake up thin, guaranteed</td>
</tr>
<tr>
<td>Stop eating the foods you love</td>
<td>Be sore for two to four weeks</td>
</tr>
<tr>
...
<tr>
<td>Physical soreness</td>
<td></td>
</tr>
<tr>
<td>Feelings of embarrassment at not knowing how to exercise</td>
<td></td>
</tr>
<tr>
...
<tr>
<td>Actual nausea working out</td>
<td></td>
</tr>
<tr>
<td>Meal prepping</td>
...
<tr>
<td>New groceries/more expensive</td>
<td></td>
</tr>
<tr>
<td>New clothing (can be a benefit for some folks)</td>
<td></td>
</tr>
<tr>
<td>Fear of gaining it back after all this effort (impermanence)</td>
<td></td>
</tr>
<tr>
<td>Etc . . .</td>
...
<tbody>
<tr>
<td><b>Dream Outcome</b></td>
<td>“Relaxation”<br>“Decreased Anxiety”<br>“Feelings of well-being”</td>
<td>1/1</td>
<td>“Relaxation” “Decreased Anxiety” “Feelings of well-being”</td>
<td>1/1</td>
</tr>
<tr>
<td><b>Perceived Likelihood</b></td>
<td>Low, since most people get distracted and don’t actually think they’ll follow through with daily meditation</td>
<td>0/1</td>
<td>High, since most people are confident that if they take the pill, it will make them feel more relaxed</td>
<td>1/1</td>
</tr>
<tr>
<td><b>Time Delay</b></td>
<td>Long time to yield long term results. Some immediate benefits after 10 to 20 minutes (assuming you don’t get frustrated)</td>
<td>.5/1</td>
<td>15 minutes for effects to be felt</td>
<td>1/1</td>
</tr>
<tr>
<td><b>Effort & Sacrifice</b></td>
<td>Physical discomfort (numb body limbs often). Mental discomfort (feeling like you are failing at it constantly). Time sacrifice (you have to set time aside everyday to do it).</td>
<td>0/1</td>
<td>Swallowing the pill</td>
<td>1/1</td>
</tr>
<tr>
<td><b>Overall Value</b></td>
<td><b>Low</b></td>
<td>1.5/4</td>
<td><b>High</b></td>
<td>4/4</td>
...
This is also the reason that the supplement industry ($123B, *Grandview Research*) is twice the size of the health club industry ($62B, *IHRSA*). They both accomplish the same perceived objectives — “being healthy,” “losing weight,”
...
_PS_ - If you feel good about helping a faceless entrepreneur, you are my kind of people. I’m that much more excited to help you crush it in the coming chapters (you’ll love the tactics I’m about to go over).  
_PPS_ - Life hack: if you introduce something valuable to someone, they associate that value with you. If you’d like goodwill directly from another entrepreneur - send this book their way.  
...
[ A simple line drawing of a brick pointing to a light bulb ]  
...
1. **DREAM OUTCOME?**  
   (Stick figure looking at a thought bubble with a palm tree and sun)

2. **PROBLEMS / OBSTACLES**  
   (Sad face thinking about a paper with airplane, suitcase, and car icons marked with red X's)

3. **LIST ALL PROBLEMS AS SOLUTIONS**  
   Red X → Sad face → Green check → Happy face

4. **MAXIMIZE PROFIT / VALUE**  
   - ↓ Value ↑ Cost  ❌  
   - ↓ Value ↓ Cost  ❌  
   - ↑ Value ↓ Cost  ✅  
   - ↑ Value ↑ Cost  ✅  

5. **FINAL HIGH VALUE HIGH PROFIT OFFER STACK**  
   | Icon      | Value        | Cost         | Checkmark |
   |-----------|--------------|--------------|-----------|
   | Airplane  | ↑ Value      | ↓ Cost       | ✅        |
   | Suitcase  | ↑ Value      | ↑ Cost       | ✅        |
   | Car       | ↑ Value      | ↓ Cost       | ✅        |
...
So, to recap, just list out each core thing that someone has to do. Then think


---


of all the reasons they wouldn't be able to do it, or keep doing it (using the four value drivers as a guide).
...
Okay, whew. That’s a lot of problems (and a lot of intuited solutions courtesy of divergent thinking). You’ll also notice that a lot of them are  
...
# Dream Outcome
* Amazing, long relationship in 90 days
...
* How to get a list of prospective partners to choose and invite into 90 day
* How to be attracted to your chosen partner
* How to find an available partner
* How to make sure 90 days is exciting and never boring
* How to create chemistry like you've never experienced
* How to communicate in sexy, fun, and meaningful ways
...
* How to make time for hourly dopamine/oxytocin hits
* How to overcome all insecurity after/in the 90 day relationship
...
[The image shows a diagram titled "Sales to Fulfillment Continuum" with two arrows forming a cross. The horizontal arrow points left to right and is labeled "Easy to Sell" on the left side with a green smiley face, and "Hard to Sell" on the right side with a red sad face. The vertical arrow points bottom to top and is labeled "Hard to Fulfill" at the bottom with a red sad face, and "Easy to Fulfill" at the top with a green smiley face.]
...
their gym for 21 days, spend my own money on hotels, car rentals, eating out, advertising, generate the leads, work the leads, then sell for them. I would even do the first onboarding meeting with clients to get them started. In short, I did *everything*. I took on all the risk.
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        1-1, Sm Gr, 1-Many<br>
        <img src="icons_people.png" alt="Icons of one-on-one, small group, one to many" />
      </td>
      <td>
        Consumption<br>
        <img src="icons_consumption.png" alt="Icons of video play, microphone, document, live audio" />
      </td>
    </tr>
<tr>
      <td>
        DIY-DWY-DFY<br>
        <img src="icons_diy.png" alt="DIY icon, two people, checklist" />
      </td>
      <td>
        Speed & Convenience<br>
        <img src="icons_speed.png" alt="24/7, 9-5, fast clock, M-F?" />
      </td>
    </tr>
<tr>
      <td>
        Support<br>
        <img src="icons_support.png" alt="SMS, chat, email, headset, phone" />
      </td>
      <td>
        10x & 1/10th Test<br>
        X → 10x or 1/10x
  ...
  <tfoot>
    <tr>
      <td colspan="2" style="text-align:right;">© Acquisition.com LLC 2021</td>
    </tr>
  </tfoot>
</table>
...
6. **10x to 1/10<sup>th</sup> test.** If my customers paid me 10x my price (or $100,000) what would I provide? If they paid me 1/10<sup>th</sup> the price and I had to make my product more valuable than it already is, how would I do that? How could I still make them successful for 1/10<sup>th</sup> price? Stretch your mind in either direction and you’ll come up with widely different solutions.
...
> **Anecdote: Why We Must Solve _Every_ Perceived Problem**  
...
* fast cooking guides partnered with meal prep services, and  
* did in-person nutrition orientations with every client one-on-one.

Many of the “one to many” solutions require more up front work. Once created, however, they become valuable assets that create value in perpetuity.


---


It’s worth putting in the time to create these because they will create high margin profit for years to come.
...
[Drawing of a person standing under a large curved shape]  
✔
...
| Problems (red X marks) | Solutions (checked boxes) | Bundle (boxes labeled with items and $$) |
|-----------------------|--------------------------|--------------------------------------------|
...
| Before (several Rubik's cubes) | After (one Rubik's cube on a tripod with labels "1 Left", "$", "Tools 3", "Tools 2", "Tools 1") |
|-------------------------------|---------------------------------------------------------------------------------------------|
...
[Conveyor belt with Rubik's cubes on the left side and bags of money on the right side]
...
**May 2019. Arnold Schwarzenegger’s home.**
...
But I took his advice. I cut the amount of tickets we sold *and* raised the prices.”
...
<table>
  <thead>
    <tr>
      <th colspan="5">SUPPLY &amp; DEMAND CURVE</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td rowspan="5" style="vertical-align: top;">+++<br>UNITS<br>↓<br>1</td>
      <td style="border-bottom: 1px solid black; border-right: 1px solid black; text-align: center;">DEMAND</td>
      <td style="border-bottom: 1px solid black; border-left: 1px solid black; text-align: center;" rowspan="5"></td>
      <td style="border-bottom: 1px solid black; border-left: 1px solid black; text-align: center;" rowspan="5">THEORETICAL<br>MAX REVENUE<br>PRICE</td>
      <td style="border-bottom: 1px solid black; border-left: 1px solid black; text-align: center;" rowspan="5">MAX PROFIT<br>PER UNIT</td>
    </tr>
<tr>
      <td style="border-right: 1px solid black; text-align: center;">SUPPLY</td>
    </tr>
<tr>
...
<tr>
      <td>Supply</td>
      <td colspan="3" style="text-align:center;">↗ (upward sloping line)</td>
    </tr>
<tr>
      <td>Old Demand</td>
      <td colspan="3" style="text-align:center;">↘ (downward sloping line)</td>
    </tr>
<tr>
      <td>New Demand</td>
      <td colspan="3" style="text-align:center;">↘ (steeper downward sloping line)</td>
    </tr>
  </tbody>
</table>

- The intersection of Supply and Old Demand is marked.
- The intersection of Supply and New Demand is marked as "New Theoretical Max Revenue Price."
- Along the New Demand curve, moving rightward, the following factors are indicated with arrows pointing right:
  - Bonuses
  - Scarcity
  - Urgency
  - Guarantees
  - Naming
- The far right point on the New Demand curve is labeled "New Max Profit / Unit."
...
- Satisfied Demand (highlighted in green)
- Pent Up Demand (highlighted in red) → Who want to buy next time
...
- Satisfied Demand (highlighted in green)
- ~~Pent Up Demand~~ (crossed out in red) zero who want to buy next time
...
When I got into this world of acquisition, I saw mentors of mine selling days of time for $50,000+. My mind was blown for two reasons. First, because I didn’t understand how they could make so much money for a single day.


---


Second, because I didn’t understand who in their right mind was buying it. Over time, I learned.

_I’ll start with the buyer._ If I have a rare problem, and I *must* solve this problem for my own pursuit of happiness, it will consume all of my attention. By the nature of my problem being specialized, there will be very few people who can solve it. This means there is not a large supply of solvers. In many cases, I will perceive only one possible “solver” (Supply = 1).
...
I personally experienced this for the first time when I had two *different* people offer me $50,000 for a day of my time after speaking at an event. They


---


were scaling an education business in a niche (not too dissimilar from my own) and could not get past the $1M per month mark. As someone who was doing $1M per *week* in the same business type (at the time), I was a *very* specific type of person with the keys to their problem.
...
**2. Growth Rate Cap - Only accepting X clients _per week_ (on-going)**  
“We
...
**3. Cohort Cap - Only accepting….X clients _per class or cohort_.** Similar to the above, except done on whatever cadence you desire. Only accepting X amount per class or cohort over a given period is another way of thinking about it. Imagine you only start clients monthly or quarterly. This helps you get some cadences in place in your business operationally while also allowing your sales team some legitimate scarcity. Example: “We take on 100 clients 4 times a year. We open the doors then close them.” Etc.

> **Pro Tip - Provide Limited Access For Higher Ticket Services**  
> These scarcity tactics work especially well for higher ticket upsells. If you want to create one off workshops, trainings, events, seminars, consulting, etc. These are things that by their nature take time and provide more access. Paring them with clear scarcity or fixed amounts, seats, or spots will rapidly drive up the demand. But always remember _have less spots available than you think you can sell . . ._ so that when you want to do it again in the future, everyone will remember you sold out . . . _fast_. This is a compounding strategy that increases in effectiveness over time. One of the few in the marketing arsenal.
...
> If you don’t hate money, sell a *very* limited supply of 1-on-1 access. You can do that via any of the mediums described in “Delivery Cube.” Direct message access. Email Access. Phone access. Voice memo access. Zoom access. Etc. There are lots of ways you can do this.


---


But I promise you this - if you want to immediately make a lot of money, create a *very* exclusive service level based on access to you (yes, unscalable), that you cap at a *tiny* number. Price it *very* high. Then, tell people. You will make more money than you thought possible. These also tend to be some of the best clients. And limit your delivery to something that you don’t hate. For me, I hate emails and messages but don’t mind zoom calls. Make it work for your working style. The cream of the crop (the 1% of 1% will adjust and take action).
...
I’m going to show you my four favorite ways of using urgency on a consistent basis, ethically:  
1) Rolling Cohorts  
2) Rolling Seasonal Urgency  
3) Promotional or Pricing Urgency  
4) Exploding Opportunity  

They will employ urgency in your business without being phony. My favorite way of doing this is having cohorts of clients start on a regular cadence. This has the added operational benefit of helping you create a choreographed onboarding experience for new clients. As you scale, this will become increasingly important.

----

**Urgency (by x date)** → *Relates to time*  
`5...4...3...2...1...Done!`
...
<table>
  <thead>
    <tr>
      <th colspan="3">SPLINTER STACK</th>
      <th>Current Service</th>
      <th>Superior Offer</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>A</td>
      <td>PRODUCTS</td>
      <td rowspan="3">→ BONUSES</td>
      <td rowspan="2">

<table><tr><td style="background-color:#f44336; width:20px;"></td><td style="background-color:#2196f3; width:20px;"></td><td style="background-color:#4caf50; width:20px;"></td><td style="background-color:#ffeb3b; width:20px;"></td></tr></table>

</td>
      <td>

<table><tr><td style="background-color:#2196f3; width:20px;"></td><td style="background-color:#4caf50; width:20px;"></td><td style="background-color:#f44336; width:20px;"></td><td style="background-color:#ffeb3b; width:20px;"></td><td style="background-color:#9e9e9e; width:20px;"></td></tr></table>
...
On the other hand, if the person does *not* buy after the first ask, then you present a bonus that matches their perceived obstacle, then ask again. Don’t feel
...
As if that weren’t already awesome enough, if you really want to be a jedi, negotiate a group discount *and* a commission to yourself. This is exactly what
...
[Illustration of gold coins, a money bag with a dollar sign, and gold bars]
...
A) a full refund,  
B) a 50 percent refund,  
C) a refund of their ad spend and any ancillary costs incurred,  
D) you pay for a competitors program instead,  
E) you return their money plus an additional $1,000 (or other applicable amount)
...
**Wording:**  
I heard Jason Fladlien, who I referenced earlier, pitch his unconditional guarantee on a webinar and I thought it was unbelievable. These are 100% his words and not my own. I take no credit for this but have included it for completeness.

> *“I’m not asking you to decide yes or no today...I'm asking you to make a fully informed decision, that is all. The only way you can make a fully informed decision is on the inside, not the outside. So you get on the inside and see if everything we say on this webinar is true and valuable to you. Then, if it is, that’s when you decide to keep it. If it’s not for you, no hard feelings. You will then, after signing up at URL be able to make a fully informed decision that this isn’t for you. But you can’t make this decision right now for the same reason you*  


---


> don't buy a house without first looking at the inside of it. And know this...whether it’s *29 min* or *29 days* from now...*if you ain’t happy, I ain’t happy.* For any reason whatsoever, *if you want your money back you can get it because I only want to keep your money if you’re happy.* All you have to do is go to _support@xyz.com_ and tell use “gimme my money” and you got it, and in short order - _our response times to any support request average 61min over a 24/7 time period. You can only make such a guarantee when you're confident that what you have is the real deal and I'm fairly confident that when you sign up at URL you’re getting exactly what you need to BENEFIT.”_
...
**Important disclaimer**: reaching an audience one time in *no way* means an offer is fatigued. Most people don’t even notice an offer on the first mention. That’s why you need to create new creative (videos, images) and new hooks,


---


stories, and copy around the same offers. You can still use offers for a long time.  
...
[The image shows three boxes in a row, each labeled "Magical Offer" with different numbers and different patterns on the boxes. Above each box are different offer names: "Original Offer $ Value Bundle", "Fall 6 Wk Challenge", and "Spring 28 Day Blueprint". Below the boxes is the caption: "Same Bundle, Different Wrapper".]
...
| M | A | G | I | C |
|---|---|---|---|---|
| Make a Magnetic Reason | Announce the Avatar | Give Them a Goal | Indicate a Time Interval | Complete with a Container Word |
...
joke of it like the fraternity example. But this should answer one or both of the following questions: *Why are they making this great offer?* or *Why should I respond to this offer?/What’s in it for me?*
...
*But how do you get initial traction?* Good question. Try the offer structure  
...
**Free Naming Formula Checklist** for you to use and reuse with your team. It also works for naming promotions. As always, it’s absolutely free. Enjoy.
...
*Illustration of a person standing under a large curved shape*  
✔
...
- Problems: multiple red X marks inside a thought bubble with a sad face
- Solutions: multiple green check marks in boxes
- Bundle: a box labeled "Bundle" with multiple smaller boxes inside, each checked  
✔
...
| Before          | After                |
|-----------------|----------------------|
| Three Rubik's cubes labeled "Basic" | One Rubik's cube on a tripod labeled "Enhanced" |
|                 | Text: "...1 Left"     |
|                 | Tools 1, Tools 2, Tools 3 with $ signs |
|                 | Numbers: 29 ... 28    |
...
- Conveyor belt with three labeled Rubik's cubes on the left side
- On the right side of the conveyor belt, three bags of money with dollar signs
- Text in red: **You Are Here!**
...
There’s so much more to building an acquisition machine *profitably*. I could not cover it all in one book. Out of respect for you, I wanted to make this
